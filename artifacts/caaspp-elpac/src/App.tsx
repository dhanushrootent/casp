...
import TeacherSubmissionAnalysis from "@/pages/teacher/SubmissionAnalysis";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/teacher/submission-analysis">
        {() => <ProtectedRoute component={TeacherSubmissionAnalysis} allowedRoles={['teacher']} />}
      </Route>
